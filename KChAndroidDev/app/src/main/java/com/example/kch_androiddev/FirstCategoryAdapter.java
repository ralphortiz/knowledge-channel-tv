...
public class FirstCategoryAdapter extends RecyclerView.Adapter<FirstCategoryAdapter.MyViewHolder> {

    Context context;
    List<Show> mShowList = new ArrayList<>();
    OnShowClickListener onShowClickListener;

    public FirstCategoryAdapter(Context context, List<Show> mShowList, OnShowClickListener listener) {
