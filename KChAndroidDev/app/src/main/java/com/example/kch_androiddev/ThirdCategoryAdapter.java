...
public class ThirdCategoryAdapter extends RecyclerView.Adapter<ThirdCategoryAdapter.MyViewHolder> {

    Context context;
    List<Show> mShowList = new ArrayList<>();
    OnShowClickListener onShowClickListener;

    public ThirdCategoryAdapter(Context context, List<Show> mShowList, OnShowClickListener listener) {
